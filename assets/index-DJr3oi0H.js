...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ia,depthTest:!1,depthWrite:!1})}function aR(r,e,n){const a=new Float32Array(Zs),o=new K(0,1,0);return new aa({name:"SphericalGaussianBlur",defines:{n:Zs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:a},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:Xu(),fragmentShader:`
...
`)+`
`+S);const N=w+M+u,D=w+S+d,F=sx(o,o.VERTEX_SHADER,N),z=sx(o,o.FRAGMENT_SHADER,D);o.attachShader(T,F),o.attachShader(T,z),n.index0AttributeName!==void 0?o.bindAttribLocation(T,0,n.index0AttributeName):n.morphTargets===!0&&o.bindAttribLocation(T,0,"position"),o.linkProgram(T);function P(H){if(r.debug.checkShaderErrors){const $=o.getProgramInfoLog(T)||"",ae=o.getShaderInfoLog(F)||"",ue=o.getShaderInfoLog(z)||"",Q=$.trim(),I=ae.trim(),B=ue.trim();let ce=!0,Z=!0;if(o.getProgramParameter(T,o.LINK_STATUS)===!1)if(ce=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(o,T,F,z);else{const ve=ox(o,F,"vertex"),U=ox(o,z,"fragment");nt("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(T,o.VALIDATE_STATUS)+`
